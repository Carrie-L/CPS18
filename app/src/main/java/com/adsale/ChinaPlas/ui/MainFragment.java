...
//        mainViewModel.resume();
    ...
    private void setBottomImage() {
        ...
        if (App.isNetworkAvailable) {
            ...
            Glide.with(getActivity()).load("file:///android_asset/Menu/" + AppUtil.subStringLast(App.mLanguage.get() == 0 ? mainPic.LeftBottomBanner.TC.BannerImage : App.mLanguage.get() == 1 ? mainPic.LeftBottomBanner.EN.BannerImage : mainPic.LeftBottomBanner.SC.BannerImage, "/")).into(leftPic);
            Glide.with(getActivity()).load("file:///android_asset/Menu/" + AppUtil.subStringLast(App.mLanguage.get() == 0 ? mainPic.RightBottomBanner.TC.BannerImage : App.mLanguage.get() == 1 ? mainPic.RightBottomBanner.EN.BannerImage : mainPic.RightBottomBanner.SC.BannerImage, "/")).into(rightPic);

            LogUtil.i(TAG, "bottom images = " + "file:///android_asset/Menu/" + AppUtil.subStringLast(App.mLanguage.get() == 0 ? mainPic.LeftBottomBanner.TC.BannerImage : App.mLanguage.get() == 1 ? mainPic.LeftBottomBanner.EN.BannerImage : mainPic.LeftBottomBanner.SC.BannerImage, "/"));
        }
    }
