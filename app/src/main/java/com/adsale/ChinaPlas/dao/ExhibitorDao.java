...
public class ExhibitorDao extends AbstractDao<Exhibitor, String> {
    ...
    */
    public static class Properties {
        ...
        public final static Property ConfArea = new Property(32, String.class, "ConfArea", false, "CONF_AREA");
        public final static Property FreeArea = new Property(33, String.class, "FreeArea", false, "FREE_AREA");
        public final static Property PillarArea = new Property(34, String.class, "PillarArea", false, "PILLAR_AREA");
        public final static Property NewTechUpdateDate = new Property(35, String.class, "NewTechUpdateDate", false, "NEW_TECH_UPDATE_DATE");
        public final static Property SeqEN = new Property(36, Integer.class, "SeqEN", false, "SEQ_EN");
        public final static Property SeqTC = new Property(37, Integer.class, "SeqTC", false, "SEQ_TC");
        public final static Property SeqSC = new Property(38, Integer.class, "SeqSC", false, "SEQ_SC");
        public final static Property HallNo = new Property(39, String.class, "HallNo", false, "HALL_NO");
        public final static Property IsFavourite = new Property(40, Boolean.class, "IsFavourite", false, "IS_FAVOURITE");
        public final static Property Note = new Property(41, String.class, "Note", false, "NOTE");
        public final static Property Rate = new Property(42, Integer.class, "Rate", false, "RATE");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"EXHIBITOR\" (" + //
                ...
                "\"CONF_AREA\" TEXT," + // 31: PhotoFileName
                "\"FREE_AREA\" TEXT," + // 31: PhotoFileName
                "\"PILLAR_AREA\" TEXT," + // 31: PhotoFileName
                "\"NEW_TECH_UPDATE_DATE\" TEXT," + // 31: PhotoFileName
    ...
    protected void bindValues(SQLiteStatement stmt, Exhibitor entity) {
        ...
        String ConfArea = entity.getConfArea();
        if (ConfArea != null) {
            stmt.bindString(33, ConfArea);
        }
        String FreeArea = entity.getFreeArea();
        if (FreeArea != null) {
            stmt.bindString(34, FreeArea);
        }

        String PillarArea = entity.getPillarArea();
        if (PillarArea != null) {
            stmt.bindString(35, PillarArea);
        }

        String NewTechUpdateDate = entity.getNewTechUpdateDate();
        if (NewTechUpdateDate != null) {
            stmt.bindString(36, NewTechUpdateDate);
        }

 
        Integer SeqEN = entity.getSeqEN();
        if (SeqEN != null) {
            stmt.bindLong(37, SeqEN);
        }
 
        Integer SeqTC = entity.getSeqTC();
        if (SeqTC != null) {
            stmt.bindLong(38, SeqTC);
        }
 
        Integer SeqSC = entity.getSeqSC();
        if (SeqSC != null) {
            stmt.bindLong(39, SeqSC);
        }
 
        String HallNo = entity.getHallNo();
        if (HallNo != null) {
            stmt.bindString(40, HallNo);
        }
 
        Integer IsFavourite = entity.getIsFavourite();
        if (IsFavourite != null) {
            stmt.bindLong(41, IsFavourite);
        }
 
        String Note = entity.getNote();
        if (Note != null) {
            stmt.bindString(42, Note);
        }

        Integer Rate = entity.getRate();
        if (Rate != null) {
            stmt.bindLong(43, Rate);
        }
    }
    ...
    public Exhibitor readEntity(Cursor cursor, int offset) {
        Exhibitor entity = new Exhibitor( //
            ...
            cursor.isNull(offset + 32) ? null : cursor.getString(offset + 32), // PhotoFileName
            cursor.isNull(offset + 33) ? null : cursor.getString(offset + 33), // PhotoFileName
            cursor.isNull(offset + 34) ? null : cursor.getString(offset + 34), // PhotoFileName
            cursor.isNull(offset + 35) ? null : cursor.getString(offset + 35), // PhotoFileName
            cursor.isNull(offset + 36) ? null : cursor.getInt(offset + 36), // SeqEN
            cursor.isNull(offset + 37) ? null : cursor.getInt(offset + 37), // SeqTC
            cursor.isNull(offset + 38) ? null : cursor.getInt(offset + 38), // SeqSC
            cursor.isNull(offset + 39) ? null : cursor.getString(offset + 39), // HallNo
            cursor.isNull(offset + 40) ? null : cursor.getInt(offset + 40), // IsFavourite
            cursor.isNull(offset + 41) ? null : cursor.getString(offset + 41), // Note
            cursor.isNull(offset + 42) ? null : cursor.getInt(offset + 42) // Rate
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Exhibitor entity, int offset) {
        ...
        entity.setRate(cursor.isNull(offset + 38) ? null : cursor.getInt(offset + 38));
     }
