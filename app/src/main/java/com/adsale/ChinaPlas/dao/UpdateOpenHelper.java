...
public class UpdateOpenHelper extends DaoMaster.OpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        MigrationHelper.migrate(db,CompanyApplicationDao.class,ApplicationDao.class,CountryDao.class,ExhibitorDao.class,ExhibitorUserUpdateDao.class,
        		MapDao.class,IndustryDao.class,
