...
public class CountryDao extends AbstractDao<Country, String> {
    ...
    */
    public static class Properties {
        ...
        public final static Property SortEN = new Property(5, String.class, "SortEN", false, "SORT_EN");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COUNTRY\" (" + //
                ...
                "\"SORT_EN\" TEXT NOT NULL ," + // 5: SortEN
                "\"SORT_CN\" TEXT NOT NULL );"); // 6: SortCN
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Country entity) {
        ...
        stmt.bindString(6, entity.getSortEN());
        stmt.bindString(7, entity.getSortCN());
    }
    ...
    public Country readEntity(Cursor cursor, int offset) {
        Country entity = new Country( //
            ...
            cursor.getString(offset + 5), // SortEN
            cursor.getString(offset + 6) // SortCN
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Country entity, int offset) {
        ...
        entity.setSortEN(cursor.getString(offset + 5));
        entity.setSortCN(cursor.getString(offset + 6));
     }
